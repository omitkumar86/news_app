          ...
          child: Padding(
            ...
            child: Column(children: [
                                ...
                                child: InkWell(
                                  onTap: () {
                                    setState(() {
                                      ...
                                      print("dddddddddddddddd$index $currentPageIndex");
                                    });
                                  },
                                  child: Center(
                                      child: Padding(
              ...
              FutureBuilder<List<Article>>(
               ...
               future:newsType==NewsType.topTrending? newsProvider.fetchTopHeadlines( ) : newsProvider.fetchAllNewsData(page: currentPageIndex+1,sortBy:sortBy),
               //  future:  newsProvider.fetchAllNewsData(page: currentPageIndex+1,sortBy:sortBy),
                  builder: (context, snapshot) {
                    if (snapshot.connectionState == ConnectionState.waiting) {
                      ...
                      return Expanded(
                          child: EmptyNewsWidget(text: "", imagePath: "",));
                    }
                    ...
                    SizedBox(
                      ...
                      child: Swiper(
                        ...
                        itemCount: 5,
                        itemBuilder: (context, index) {
                          return TopTrendingWidget(article: snapshot.data![index] );
                        },
                      ),
                    );
